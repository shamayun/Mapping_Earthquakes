...
// create the tile layer(FIRST) that will be the background of our map.
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function(data) {
  ...
  L.geoJson(data, {
    ...
    style: styleInfo,
     ...
     onEachFeature: function(feature, layer) {
      layer.bindPopup("Magnitude: " + feature.properties.mag + "<br><h4>Location: </h4>" + feature.properties.place);
    }
  ...
  L.geoJson(data, {
    ...
    onEachFeature: function(feature, layer) {
      layer.bindPopup("Magnitude: " + feature.properties.mag + "<br><h3>Location:</h3>" + feature.properties.place);
    }
